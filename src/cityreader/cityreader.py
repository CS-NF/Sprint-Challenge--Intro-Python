...
def cityreader(cities=[]):
  ...
  # `cities` list
   ...
   with open(f"{path}/cities.csv", "r") as csv_file: # opens the city file
    ...
    for value in open_csv: # looping through csv file
      name = value[0] # getting the name of city
      lat = float(value[3]) # getting the lat which is at the index of 3
      lon = float(value[4]) # getting the lat which is at the index of 4
